...
<circle cx="220" cy="12" r="10" fill="#3563E9" stroke="white" stroke-width="4"/>
            ...
            <div className=' w-[70%]'>
            {/* <div className="second-section flex flex-col md:flex-row ml- "> 
      <div className="section2-part1 w-auto h-auto ml-[60px] md:ml-0 md:w-[582px] md:h-[132px] bg-white mt-[29px]  rounded-[10px]">
...
<line x1="0.5" y1="0.5" x2="0.5" y2="47.5" stroke="#C3D4E9" stroke-opacity="0.4" stroke-linecap="round"/>
      ...
      <div className="arrow h-[60px] w-[60px] bg-[#3563E9]  rounded-[10px] mt-[67px] p-[16px]  shadow shadow-black  ml-[120px] md:ml-0">
      ...
      <div className="section2-part2 w-auto h-auto justify-center items-center mr-5 ml-[60px] md:ml-0  md:w-[582px] md:h-[132px] bg-white mt-[29px]  rounded-[10px]  ">
    ...
    <div className="flex justify-between mt-[51px]">
        ...
        <button className="text-[#3563E9] pr-[84px]">View All</button>
         ...
         {/* product card  */}
    <div className="product-cards flex  flex-wrap gap-[10px] ml-[5px] mt-[3 0px]">
        {recomendedData.map((recData)=>(
              <div className="card ml-8 md:ml-0 h-[358px] w-[304px] bg-[white] rounded-[10px] mt-[10px]  ">
      ...
      <div className="flex justify-center items-center">
        <Link href="/">
      <button className="h-[44px] w-[150px] bg-[#3563E9] rounded-[4px] text-[#fff] mt-[30px] ml-24 mb-4 ">Show More Car</button>
      </Link>
      </div>
      </div>

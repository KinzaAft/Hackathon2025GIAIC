...
<circle cx="220" cy="12" r="10" fill="#3563E9" stroke="white" stroke-width="4"/>
        ...
        <div className="imagecar2 w-full md:w-[406px] mt-4 h-[116px] ml-0  md:ml-[17px]"></div>
      </div> 
      <div className='flex justify-evenly'>
      <div className='h-[124px] w-[148px] bg-black rounded-lg mt-[20px]'></div>
      <div className='h-[124px] w-[148px] bg-black rounded-lg mt-[20px]'></div>
      <div className='h-[124px] w-[148px] bg-black rounded-lg mt-[20px]'></div>
...
<p className='text-[#596780] ml-3'>440+ Reviewer </p>
        ...
        <div>
            ...
            <p className='text-[#596780] font-medium ml-[24px]'>Sport</p> 
            <p className='text-[#8693a8] font-medium ml-[24px] '>Capaity</p> 
            <p className='text-[#596780]  font-medium ml-[24px] '>2 Person</p> 
        </div>
        <div className='flex  justify-evenly p-2'>
            ...
            <p className='text-[#596780]  font-medium ml-[24px] '>70L</p> 
        </div>
        <div className='flex align-bottom justify-between'>
        <p className='text-black font-medium text-[28px] mt-9 ml-[24px]'>$80.00/ <span className='text-[#90A3BF] text-[16px]'>days</span></p>
